      ...
      Class.new(GraphQL::Schema) do
        ...
        query_type = Class.new(GraphQL::Schema::Object) do
          ...
          field :test, Integer, null: false do
            argument :a, Integer, required: true, validates: { numericality: { greater_than_or_equal_to: 1 } }
            argument :b, Integer, required: true, validates: { numericality: { greater_than_or_equal_to: 1 } }
          end
